...
package de.schildbach.wallet.digitalcoin.integration.android;
 ...
 */
public final class DigitalcoinIntegration
{
	private static final String INTENT_EXTRA_TRANSACTION_HASH = "transaction_hash";

	/**
	 * Request any amount of Digitalcoins (probably a donation) from user, without feedback from the app.
	 * 
	 * @param context
	 *            Android context
	 * @param address
	...
	/**
	 * Request specific amount of Digitalcoins from user, without feedback from the app.
	 *
	 * @param context
	 *            Android context
	 * @param address
	 *            Digitalcoin address
	 * @param amount
	 *            Digitalcoin amount in nanocoins
	 */
	...
	/**
	 * Request any amount of Digitalcoins (probably a donation) from user, with feedback from the app. Result intent can be
	 ...
	 * 
	 * Warning: A success indication is no guarantee! To be on the safe side, you must drive your own Digitalcoin
	...
	/**
	 * Request specific amount of Digitalcoins from user, with feedback from the app. Result intent can be received by
	...
	/**
	 * Put transaction hash into result intent. Meant for usage by Digitalcoin wallet applications.
	 * 
	 * @param result
	 *            result intent
	 * @param txHash
	...
	/**
	 * Get transaction hash from result intent. Meant for usage by applications initiating a Digitalcoin payment.
	 * 
	 * You can use this hash to request the transaction from the Digitalcoin network, in order to validate. For this, you
	 * need your own Digitalcoin infrastructure though. There is no guarantee that the transaction has ever been broadcasted
	 * to the Digitalcoin network.
	 * 
	 * @param result
	 *            result intent
	...
	private static void redirectToDownload(final Context context)
	{
		...
		final Intent binaryIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("http://github.com/ahmedbodi/digitalcoin-wallet"));
