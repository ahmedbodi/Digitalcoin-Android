...
import de.schildbach.wallet.digitalcoin.util.IOUtils;
...
public class ExchangeRatesProvider extends ContentProvider
{
	...
	public Cursor query(final Uri uri, final String[] projection, final String selection, final String[] selectionArgs, final String sortOrder)
	{
		...
		{
			Map<String, ExchangeRate> newExchangeRates = getdigitalcoinCharts();
		...
		else if (selection.equals(KEY_CURRENCY_CODE))
		{
            ...
            try {
			  cursor.newRow().add(code.hashCode()).add(rate.currencyCode).add(rate.rate.longValue()).add(rate.source);
                ...
                Log.e("digitalcoin", "Unable to add an exchange rate.  NullPointerException.");
            }
		}
	...
	private static Map<String, ExchangeRate> getdigitalcoinCharts()
	{
...
/*          String currencies[] = {"USD", "BTC", "RUR"};
            ...
            try
            {
                ...
                JSONObject ticker = head.getJSONObject("ticker");
                Double avg = ticker.getDouble("avg");
                // This is digitalcoins priced in bitcoins
                btcRate = avg;
            ...
            try
            {
                ...
                JSONObject ticker = head.getJSONObject("ticker");
                Double avg = ticker.getDouble("avg");
                // This is bitcoins priced in euros.  We want DGC!
                avg *= btcRate;
                String s_avg = String.format("%.4f", avg).replace(',', '.');
