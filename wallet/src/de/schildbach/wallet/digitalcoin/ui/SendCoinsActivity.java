...
public final class SendCoinsActivity extends AbstractWalletActivity
{
	...
	private void handleIntent(final Intent intent)
	{
		...
		if ((Intent.ACTION_VIEW.equals(action) || NfcAdapter.ACTION_NDEF_DISCOVERED.equals(action)) && intentUri != null && "digitalcoin".equals(scheme))
		{
			try
			{
				final DigitalcoinURI digitalcoinUri = new DigitalcoinURI(null, intentUri.toString());
				address = digitalcoinUri.getAddress().toString();
				addressLabel = digitalcoinUri.getLabel();
				amount = digitalcoinUri.getAmount();
			}
