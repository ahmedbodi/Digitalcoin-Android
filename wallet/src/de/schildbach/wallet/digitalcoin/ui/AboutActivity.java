...
public final class AboutActivity extends SherlockPreferenceActivity
{
	...
	private static final String KEY_ABOUT_CREDITS_LITECOINJ = "about_credits_digitalcoinj";
	...
	protected void onCreate(final Bundle savedInstanceState)
	{
		...
		findPreference(KEY_ABOUT_CREDITS_LITECOINJ).setTitle(getString(R.string.about_credits_Digitalcoinj_title, VersionMessage.LITECOINJ_VERSION));
	...
	public boolean onPreferenceTreeClick(final PreferenceScreen preferenceScreen, final Preference preference)
	{
		...
		else if (KEY_ABOUT_CREDITS_LITECOINJ.equals(key))
		{
			startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse(Constants.CREDITS_LITECOINJ_URL)));
			finish();
		}
