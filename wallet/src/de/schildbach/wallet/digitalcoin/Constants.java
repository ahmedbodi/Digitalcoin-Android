...
public class Constants
{
	...
	private static final String EXTERNAL_WALLET_KEY_BACKUP_PROD = "digitalcoin-wallet-keys";
	private static final String EXTERNAL_WALLET_KEY_BACKUP_TEST = "digitalcoin-wallet-keys-testnet";
	...
	public static final String PEER_DISCOVERY_IRC_CHANNEL_PROD = "#digitalcoin00";
	public static final String PEER_DISCOVERY_IRC_CHANNEL_TEST = "#digitalcoinTEST3";

	private static final String BLOCKEXPLORER_BASE_URL_PROD = "http://dgc.cryptocoinexplorer.com/";
	private static final String BLOCKEXPLORER_BASE_URL_TEST = "http://dgc.cryptocoinexplorer.com/";
	public static final String BLOCKEXPLORER_BASE_URL = TEST ? BLOCKEXPLORER_BASE_URL_TEST : BLOCKEXPLORER_BASE_URL_PROD;

	public static final String MIMETYPE_TRANSACTION = "application/x-dgctx";

	public static final int MAX_NUM_CONFIRMATIONS = 7;
	public static final String USER_AGENT = "digitalcoin Wallet";
	...
	public static final String CURRENCY_CODE_LITECOIN = "DGC";
	...
	public static final String DONATION_ADDRESS = "D6tdmDCUkZEUaUyLx4dhZH992yTEJSL1tU";
	public static final String REPORT_EMAIL = "ahmed_bodi@msn.com";
	public static final String REPORT_SUBJECT_ISSUE = "Reported issue";
	public static final String REPORT_SUBJECT_CRASH = "Crash report";

	public static final String LICENSE_URL = "http://www.gnu.org/licenses/gpl-3.0.txt";
	public static final String SOURCE_URL = "https://github.com/ahmedbodi/digitalcoin-wallet/";
	public static final String BINARY_URL = "https://crypto-expert.com/Wallets/";
	public static final String CREDITS_LITECOINJ_URL = "http://code.google.com/p/bitcoinj/";
	public static final String CREDITS_ZXING_URL = "http://code.google.com/p/zxing/";
	public static final String CREDITS_ICON_URL = "https://digitalcoin.co/";
	public static final String AUTHOR_TWITTER_URL = "https://twitter.com/CryptoExpert";
	public static final String AUTHOR_GOOGLEPLUS_URL = "https://profiles.google.com/ahmedbodiwala";
	public static final String MARKET_APP_URL = "market://details?id=%s";
	public static final String WEBMARKET_APP_URL = "https://play.google.com/store/apps/details?id=%s";
	public static final String MARKET_PUBLISHER_URL = "market://search?q=pub:\"CryptoExpert\"";
	...
	public static final String PREFS_KEY_WDC_PRECISION = "ltc_precision";
