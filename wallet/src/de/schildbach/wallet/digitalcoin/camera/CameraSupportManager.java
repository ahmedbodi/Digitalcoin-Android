...
import de.schildbach.wallet.digitalcoin.util.PlatformSupportManager;
...
public class CameraSupportManager extends PlatformSupportManager<CameraInterface>
{
	public CameraSupportManager()
	{
		...
		//addImplementationClass(Build.VERSION_CODES.GINGERBREAD, "de.schildbach.wallet.digitalcoin.camera.GingerbreadCameraInterface");
	}
}
