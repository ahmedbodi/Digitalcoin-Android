...
/**
 * A Peer handles the high level communication with a Digitalcoin node.
 *
 * <p>{@link Peer#getHandler()} is part of a Netty Pipeline with a Digitalcoin serializer downstream of it.
 */
public class Peer {
    ...
    private static class GetDataRequest {
        ...
        // a nasty hack that relies on the fact that digitalcoin-qt is single threaded and processes messages in order.
    ...
    class PeerHandler extends SimpleChannelHandler {
        ...
        /** Handle incoming Digitalcoin messages */
        @Override
    ...
    /** Returns the Netty Pipeline stage handling the high level Digitalcoin protocol. */
    ...
    private void blockChainDownload(Sha256Hash toHash) throws IOException {
        ...
        try {
            ...
            //
            //   https://en.digitalcoin.it/wiki/Protocol_specification#getblocks
            //
