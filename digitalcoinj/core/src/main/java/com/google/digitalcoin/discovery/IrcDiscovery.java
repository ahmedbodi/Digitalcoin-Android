...
public class IrcDiscovery implements PeerDiscovery {
     ...
     * disconnecting.
     *
     * @param channel The IRC channel to join, either "#digitalcoin" or "#digitalcoinTEST3" for the production and test networks
     *                respectively.
     */
    public IrcDiscovery(String channel) {
        this(channel, "irc.freenode.net", 6667);
    }
    ...
    static ArrayList<InetSocketAddress> parseUserList(String[] userNames) throws UnknownHostException {
        ...
        for (String user : userNames) {
            // All Digitalcoin peers start their nicknames with a 'u' character.
            ...
            try {
                ...
                // so simply beginning with "u" does not imply this is a valid Digitalcoin encoded address.
                //
