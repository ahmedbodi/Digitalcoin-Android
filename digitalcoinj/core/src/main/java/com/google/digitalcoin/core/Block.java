...
import static com.google.digitalcoin.core.Utils.doubleDigest;
import static com.google.digitalcoin.core.Utils.scryptDigest;
import static com.google.digitalcoin.core.Utils.doubleDigestTwoBuffers;

/**
 * <p>A block is a group of transactions, and is one of the fundamental data structures of the Digitalcoin system.
 ...
 * <a href="http://www.digitalcoin.org/digitalcoin.pdf">the Digitalcoin technical paper</a> for
...
public class Block extends Message {
     ...
     * upgrade everyone to change this, so Digitalcoin can continue to grow. For now it exists as an anti-DoS measure to
    ...
    /** Constructs a block object from the Digitalcoin wire format. */
    ...
    /**
     * Contruct a block object from the Digitalcoin wire format.
    ...
    /**
     * <p>A utility method that calculates how much new Digitalcoin would be created by the block at the given height.
     * The inflation of Digitalcoin is predictable and drops roughly every 4 years (210,000 blocks). At the dawn of
     * the system it was 50 coins per block, in late 2012 it went to 25 coins per block, and so on. The size of
     * a coinbase transaction is inflation plus fees.</p>
     *
     * <p>The half-life is controlled by {@link com.google.digitalcoin.core.NetworkParameters#getSubsidyDecreaseBlockCount()}.
     * </p>
     */
    ...
    private void writeTransactions(OutputStream stream) throws IOException {
        ...
        if (transactions != null) {
            ...
            for (Transaction tx : transactions) {
                tx.digitalcoinSerialize(stream);
            }
        }
    }
     ...
     * @throws IOException
     */
    public byte[] digitalcoinSerialize() {
    ...
    @Override
    protected void digitalcoinSerializeToStream(OutputStream stream) throws IOException {
        writeHeader(stream);
    ...
    /** Returns the version of the block data structure as defined by the Digitalcoin protocol. */
     ...
     * {@link com.google.digitalcoin.core.Block#getDifficultyTargetAsInteger()}. Note that this is <b>not</b> the same as
     * the difficulty value reported by the Digitalcoin "getdifficulty" RPC that you may see on various block explorers.
    ...
    void addCoinbaseTransaction(byte[] pubKeyTo, BigInteger value) {
        ...
        coinbase.length = coinbase.digitalcoinSerialize().length;
