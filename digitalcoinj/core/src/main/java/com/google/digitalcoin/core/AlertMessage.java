 ...
 * The private keys are held by a small group of core Digitalcoin developers, and alerts may be broadcast in the event of
...
public class AlertMessage extends Message {
    ...
    void parse() throws ProtocolException {
        ...
        version = readUint32();
        // Read the timestamps. Digitalcoin uses seconds since the epoch.
