...
{
	private static final String DONATION_ADDRESS = "1jbfsTy6DsaRyfStzoWTPppWwDnZ"; // prodnet
	...
	protected void onCreate(final Bundle savedInstanceState)
	{
		...
		donateButton.setOnClickListener(new OnClickListener()
		{
			...
			{
				DigitalcoinIntegration.requestForResult(SampleActivity.this, REQUEST_CODE, DONATION_ADDRESS);
			}
		});
	...
	protected void onActivityResult(final int requestCode, final int resultCode, final Intent data)
	{
		if (requestCode == REQUEST_CODE)
		{
			...
			{
				final String txHash = DigitalcoinIntegration.transactionHashFromResult(data);
				if (txHash != null)
				{
