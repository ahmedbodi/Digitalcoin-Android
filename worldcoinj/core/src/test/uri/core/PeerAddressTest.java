...
public class PeerAddressTest
{
    ...
    public void testPeerAddressRoundtrip() throws Exception {
        // copied verbatim from https://en.digitalcoin.it/wiki/Protocol_specification#Network_address
        ...
        String reserialized = Utils.bytesToHexString(pa.digitalcoinSerialize());
        assertEquals(reserialized,fromSpec );
    }

    @Test
    public void testDigitalcoinSerialize() throws Exception {
        ...
        assertEquals("000000000000000000000000000000000000ffff7f000001208d",
                Utils.bytesToHexString(pa.digitalcoinSerialize()));
    }
}
