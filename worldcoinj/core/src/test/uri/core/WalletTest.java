...
import static com.google.digitalcoin.core.TestUtils.*;
import static com.google.digitalcoin.core.TestUtils.createFakeBlock;
...
import static com.google.digitalcoin.core.Utils.toNanoCoins;
...
public class WalletTest {
    ...
    private void basicSpendingCommon(Wallet wallet, Address toAddress, boolean testEncryption) throws Exception {
        ...
        // will attach a small fee. Because the Digitalcoin protocol makes it
    ...
    public void blockChainCatchup() throws Exception {
        ...
        assertEquals(digitalcoinValueToFriendlyString(wallet.getBalance()), "0.90");
        assertEquals(null, txn[0]);
        assertEquals(2, confTxns.size());
        assertEquals(txn[1].getHash(), send1.getHash());
        assertEquals(digitalcoinValueToFriendlyString(bigints[2]), "1.00");
        assertEquals(digitalcoinValueToFriendlyString(bigints[3]), "0.90");
        ...
        assertEquals(digitalcoinValueToFriendlyString(wallet.getBalance()), "0.80");
    ...
    public void balances() throws Exception {
        ...
        Transaction send1 = wallet.createSend(new ECKey().toAddress(params), toNanoCoins(0, 10));
        // Reserialize.
        Transaction send2 = new Transaction(params, send1.digitalcoinSerialize());
    ...
    public void isConsistent_duplicates() throws Exception {
        ...
        Transaction txClone = new Transaction(params, tx.digitalcoinSerialize());
        try {
    ...
    public void doubleSpendUnspendsOtherInputs() throws Exception {
        ...
        send2 = new Transaction(params, send2.digitalcoinSerialize());
    ...
    public void pending1() throws Exception {
        ...
        final Transaction t1Copy = new Transaction(params, t1.digitalcoinSerialize());
    ...
    public void spendToSameWallet() throws Exception {
        ...
        assertEquals(BigInteger.ZERO, wallet.getBalance());
        sendMoneyToWallet(outbound1, AbstractBlockChain.NewBlockType.BEST_CHAIN);
        // We should have a balance of 1 WDC after the block is received.
        assertEquals(coin1, wallet.getBalance());
    }
