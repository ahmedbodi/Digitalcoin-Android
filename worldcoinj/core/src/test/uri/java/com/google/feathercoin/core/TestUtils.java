...
public class TestUtils {
    ...
    /**
     * @return Transaction[] Transaction[0] is a feeder transaction, supplying WDC to Transaction[1]
     */
    public static Transaction[] createFakeTx(NetworkParameters params, BigInteger nanocoins,
        ...
        // Create fake TXes of sufficient realism to exercise the unit tests. This transaction send WDC from the
    ...
    public static Transaction roundTripTransaction(NetworkParameters params, Transaction tx) throws IOException, ProtocolException {
        FeathercoinSerializer bs = new FeathercoinSerializer(params);
    ...
    public static DoubleSpends createFakeDoubleSpendTxns(NetworkParameters params, Address to) {
        ...
        try {
            doubleSpends.t1 = new Transaction(params, doubleSpends.t1.feathercoinSerialize());
            doubleSpends.t2 = new Transaction(params, doubleSpends.t2.feathercoinSerialize());
