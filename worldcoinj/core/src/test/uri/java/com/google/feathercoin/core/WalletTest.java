...
public class WalletTest {
    ...
    private void basicSpendingCommon(Wallet wallet, Address toAddress, boolean testEncryption) throws Exception {
        ...
        // will attach a small fee. Because the Feathercoin protocol makes it
    ...
    public void blockChainCatchup() throws Exception {
        ...
        assertEquals(feathercoinValueToFriendlyString(wallet.getBalance()), "0.90");
        assertEquals(null, txn[0]);
        assertEquals(2, confTxns.size());
        assertEquals(txn[1].getHash(), send1.getHash());
        assertEquals(feathercoinValueToFriendlyString(bigints[2]), "1.00");
        assertEquals(feathercoinValueToFriendlyString(bigints[3]), "0.90");
        ...
        assertEquals(feathercoinValueToFriendlyString(wallet.getBalance()), "0.80");
    ...
    public void balances() throws Exception {
        ...
        Transaction send1 = wallet.createSend(new ECKey().toAddress(params), toNanoCoins(0, 10));
        // Reserialize.
        Transaction send2 = new Transaction(params, send1.feathercoinSerialize());
    ...
    public void isConsistent_duplicates() throws Exception {
        ...
        Transaction txClone = new Transaction(params, tx.feathercoinSerialize());
        try {
    ...
    public void doubleSpendUnspendsOtherInputs() throws Exception {
        ...
        send2 = new Transaction(params, send2.feathercoinSerialize());
    ...
    public void pending1() throws Exception {
        ...
        final Transaction t1Copy = new Transaction(params, t1.feathercoinSerialize());
    ...
    public void autosaveImmediate() throws Exception {
        ...
        File f = File.createTempFile("feathercoinj-unit-test", null);
