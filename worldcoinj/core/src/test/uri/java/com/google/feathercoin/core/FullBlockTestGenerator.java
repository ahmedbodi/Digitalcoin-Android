...
public class FullBlockTestGenerator {
    // Used by FeathercoindComparisonTool and FullPrunedBlockChainTest to create test cases
    ...
    public List<BlockAndValidity> getBlocksToTest(boolean addExpensiveBlocks) throws ScriptException, ProtocolException, IOException {
        ...
        // Extend the b24 chain to make sure feathercoind isn't accepting b24
        ...
        // Extend the b26 chain to make sure feathercoind isn't accepting b26
        ...
        // Extend the b28 chain to make sure feathercoind isn't accepting b28
        ...
        Block b56;
        try {
            b56 = new Block(params, b57.feathercoinSerialize());
        ...
        Block b64;
        {
            ...
            for (Transaction transaction : b64Created.getTransactions())
                transaction.feathercoinSerialize(stream);
            ...
            Preconditions.checkState(Arrays.equals(stream.toByteArray(), b64.feathercoinSerialize()));
