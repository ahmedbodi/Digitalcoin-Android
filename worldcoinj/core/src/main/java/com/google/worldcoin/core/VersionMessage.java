...
public class VersionMessage extends Message {
    ...
    public static final String LIBRARY_SUBVER = "/DigitalcoinJ:" + LITECOINJ_VERSION + "/";
    ...
    @Override
    public void digitalcoinSerializeToStream(OutputStream buf) throws IOException {
        ...
        try {
            // My address.
            myAddr.digitalcoinSerialize(buf);
            // Their address.
            theirAddr.digitalcoinSerialize(buf);
        } catch (UnknownHostException e) {
     ...
     * name:version pairs separated by slashes in the form of a path. For example a typical subVer field for DigitalcoinJ
     * users might look like "/DigitalcoinJ:0.4-SNAPSHOT/MultiBit:1.2/" where libraries come further to the left.<p>
     *
     ...
     * set of "/DigitalcoinJ:1.0/MultiBit:1.0(Windows)/. Therefore the / ( and ) characters are reserved in all these
     * components. If you don't want to add a comment (recommended), pass null.<p>
     *
     * See <a href="https://en.digitalcoin.it/wiki/BIP_0014">BIP 14</a> for more information.
     *
