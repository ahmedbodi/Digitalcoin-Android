...
/**
 * <p>A {@code TCPNetworkConnection} is used for connecting to a Digitalcoin node over the standard TCP/IP protocol.<p>
 *
...
public class TCPNetworkConnection implements NetworkConnection {
    ...
    private DigitalcoinSerializer serializer = null;
    ...
    public TCPNetworkConnection(NetworkParameters params, VersionMessage ver) {
        ...
        this.serializer = new DigitalcoinSerializer(this.params);
    ...
    public class NetworkHandler extends ReplayingDecoder<VoidEnum> implements ChannelDownstreamHandler {
        ...
        // Attempt to decode a Digitalcoin message passing upstream in the channel.
        //
        ...
        /** Serialize outgoing Digitalcoin messages passing downstream in the channel. */
    ...
    /** Returns the Netty Pipeline stage handling Digitalcoin serialization for this connection. */
