...
/**
 * A collection of various utility methods that are helpful for working with the Digitalcoin protocol.
 * To enable debug logging from the library, run with -Ddigitalcoinj.logging=true on your command line.
 */
public class Utils {
    ...
    /** The string that prefixes all text messages signed using Digitalcoin keys. */
    public static final String LITECOIN_SIGNED_MESSAGE_HEADER = "Digitalcoin Signed Message:\n";

    // TODO: Replace this nanocoins business with something better.

    /**
     * How many "nanocoins" there are in a Digitalcoin.
     * <p/>
     * A nanocoin is the smallest unit that can be transferred using Digitalcoin.
    ...
    /**
     * How many "nanocoins" there are in 0.01 Digitalcoins.
     * <p/>
     * A nanocoin is the smallest unit that can be transferred using Worldoin.
     * The term nanocoin is very misleading, though, because there are only 100 million
     * of them in a coin (whereas one would expect 1 billion).
     */
     ...
     * standard procedure in Digitalcoin. The resulting hash is in big endian form.
     */
     ...
     */
    public static String digitalcoinValueToFriendlyString(BigInteger value) {
    ...
    /**
     * <p>
     * Returns the given value as a plain string denominated in WDC.   
     * The result is unformatted with no trailing zeroes.
     * For instance, an input value of BigInteger.valueOf(150000) nanocoin gives an output string of "0.0015" WDC
     * </p>
     * 
     * @param value The value in nanocoins to convert to a string (denominated in WDC)
     * @throws IllegalArgumentException
     *            If the input value is null
     */
    public static String digitalcoinValueToPlainString(BigInteger value) {
        if (value == null) {
            throw new IllegalArgumentException("Value cannot be null");
        }
                
        BigDecimal valueInWDC = new BigDecimal(value).divide(new BigDecimal(Utils.COIN));
        return valueInWDC.toPlainString();
    }
     ...
     *
     * <tt><p>[24] "Digitalcoin Signed Message:\n" [message.length as a varint] message</p></tt>
     */
