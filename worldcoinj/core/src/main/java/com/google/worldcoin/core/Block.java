 ...
 * <a href="http://www.feathercoin.org/feathercoin.pdf">the Feathercoin technical paper</a> for
...
public class Block extends Message {
    ...
    /** Constructs a block object from the Feathercoin wire format. */
    ...
    /**
     * <p>A utility method that calculates how much new Feathercoin would be created by the block at the given height.
     * The inflation of Feathercoin is predictable and drops roughly every 4 years (210,000 blocks). At the dawn of
     * the system it was 50 coins per block, in late 2012 it went to 25 coins per block, and so on. The size of
     * a coinbase transaction is inflation plus fees.</p>
     *
     * <p>The half-life is controlled by {@link com.google.feathercoin.core.NetworkParameters#getSubsidyDecreaseBlockCount()}.
     * </p>
     */
    ...
    private void writeTransactions(OutputStream stream) throws IOException {
        ...
        if (transactions != null) {
            ...
            for (Transaction tx : transactions) {
                tx.feathercoinSerialize(stream);
            }
        }
    }
     ...
     * @throws IOException
     */
    public byte[] feathercoinSerialize() {
    ...
    @Override
    protected void feathercoinSerializeToStream(OutputStream stream) throws IOException {
        writeHeader(stream);
     ...
     * {@link com.google.feathercoin.core.Block#getDifficultyTargetAsInteger()}. Note that this is <b>not</b> the same as
     * the difficulty value reported by the Feathercoin "getdifficulty" RPC that you may see on various block explorers.
    ...
    /**
     * Create a block sending 50WDC as a coinbase transaction to the public key specified.
