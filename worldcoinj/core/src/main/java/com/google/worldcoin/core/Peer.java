...
/**
 * A Peer handles the high level communication with a Feathercoin node.
 *
  ...
  private void processMessage(MessageEvent e, Message m) throws IOException, VerificationException, ProtocolException {
    ...
    private void blockChainDownload(Sha256Hash toHash) throws IOException {
        ...
        try {
            ...
            //
            //   https://en.feathercoin.it/wiki/Protocol_specification#getblocks
            //
     ...
     * Once the pong is received the value returned by {@link com.google.feathercoin.core.Peer#getLastPingTime()} is
     * updated.
    ...
    /**
     * Returns the elapsed time of the last ping/pong cycle. If {@link com.google.feathercoin.core.Peer#ping()} has never
    ...
    /**
     * Returns a moving average of the last N ping/pong cycles. If {@link com.google.feathercoin.core.Peer#ping()} has never
