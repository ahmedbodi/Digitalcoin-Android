 ...
 *
 * <p>Feathercoin transactions don't specify what they do directly. Instead <a href="https://en.feathercoin.it/wiki/Script">a
...
public class Script {
    ...
    public byte[] getPubKeyHash() throws ScriptException {
        ...
        // Otherwise, the third element is the hash of the public key, ie the feathercoin address.
     ...
     * logic is defined by <a href="https://en.feathercoin.it/wiki/BIP_0016">BIP 16</a>.</p>
     *
     * <p>feathercoinj does not support creation of P2SH transactions today. The goal of P2SH is to allow short addresses
     * even for complex scripts (eg, multi-sig outputs) so they are convenient to work with in things like QRcodes or
     * with copy/paste, and also to minimize the size of the unspent output set (which improves performance of the
     * Feathercoin system).</p>
     */
