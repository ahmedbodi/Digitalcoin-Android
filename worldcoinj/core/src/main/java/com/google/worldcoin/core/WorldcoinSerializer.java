...
/**
 * <p>Methods to serialize and de-serialize messages to the Digitalcoin network format as defined in
 * <a href="https://en.digitalcoin.it/wiki/Protocol_specification">the protocol specification</a>.</p>
 *
 ...
 * <li>Message.digitalcoinSerializeToStream() needs to be properly subclassed</li>
 * </ul>
 */
public class DigitalcoinSerializer {
    private static final Logger log = LoggerFactory.getLogger(DigitalcoinSerializer.class);
    ...
    /**
     * Constructs a DigitalcoinSerializer with the given behavior.
     *
     * @param params           networkParams used to create Messages instances and termining packetMagic
     */
    public DigitalcoinSerializer(NetworkParameters params) {
     ...
     */
    public DigitalcoinSerializer(NetworkParameters params, boolean parseLazy, boolean parseRetain) {
        this.params = params;
    ...
    public void serialize(Message message, OutputStream out) throws IOException {
        ...
        if (name == null) {
            throw new Error("DigitalcoinSerializer doesn't currently know how to serialize " + message.getClass());
        }
        ...
        byte[] payload = message.digitalcoinSerialize();
    ...
    public Message deserialize(InputStream in) throws ProtocolException, IOException {
        // A Digitalcoin protocol message has the following format.
        //
        ...
        DigitalcoinPacketHeader header = new DigitalcoinPacketHeader(in);
     ...
     */
    public DigitalcoinPacketHeader deserializeHeader(InputStream in) throws ProtocolException, IOException {
        return new DigitalcoinPacketHeader(in);
    }

    /**
     * Deserialize payload only.  You must provide a header, typically obtained by calling
     * {@link DigitalcoinSerializer#deserializeHeader}.
     */
    public Message deserializePayload(DigitalcoinPacketHeader header, InputStream in) throws ProtocolException, IOException {
        int readCursor = 0;
    ...
    public static class DigitalcoinPacketHeader {
        public final byte[] header;
        public final String command;
        public final int size;
        public final byte[] checksum;

        public DigitalcoinPacketHeader(InputStream in) throws ProtocolException, IOException {
