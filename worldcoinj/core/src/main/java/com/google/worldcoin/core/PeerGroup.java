...
public class PeerGroup extends AbstractIdleService {
    ...
    // pipeline with the feathercoin serializer ({@code TCPNetworkConnection}) downstream
     ...
     * <a href="https://en.feathercoin.it/wiki/BIP_0014">BIP 14</a>.
     *
     ...
     * peers. By using this with {@link com.google.feathercoin.core.PeerGroup#getMaxConnections()} you can wait until the
     ...
     * {@link com.google.feathercoin.core.PeerGroup#getMaxConnections()} returns is used.
     * @return
     */
    ...
    /**
     * See {@link com.google.feathercoin.core.PeerGroup#getMinBroadcastConnections()}.
     */
     ...
     * someone and want to know that it's valid. It's a bit of a weird hack because the current version of the Feathercoin
     ...
     * times are available via {@link com.google.feathercoin.core.Peer#getLastPingTime()} but it increases load on the
     ...
     * using {@link com.google.feathercoin.core.Peer#ping()}.
     */
