...
public class TransactionOutput extends ChildMessage implements Serializable {
    ...
    // These fields are Java serialized but not Digitalcoin serialized. They are used for tracking purposes in our wallet
    ...
    */
    ...
    public String toString() {
        try {
            return "TxOut of " + Utils.digitalcoinValueToFriendlyString(value) + " to " + getScriptPubKey().getToAddress()
