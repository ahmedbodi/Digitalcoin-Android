 ...
 * Feathercoin system, with the downside being a larg cost in system resources. Fully verifying means all unspent transaction
    ...
    protected TransactionOutputChanges connectTransactions(int height, Block block)
        ...
        try {
            if (!params.isCheckpoint(height)) {
                ...
                // BIP30 document for more details on this: https://en.feathercoin.it/wiki/BIP_0030
            ...
            for (Transaction tx : block.transactions) {
                ...
                if (!isCoinBase) {
                    ...
                    for (int index = 0; index < tx.getInputs().size(); index++) {
                        ...
                        // In my tests, total time spent in com.google.feathercoin.core when
                        ...
                        try {
                            txCache = new Transaction(params, tx.unsafeFeathercoinSerialize());
