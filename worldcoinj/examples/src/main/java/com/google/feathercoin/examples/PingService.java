 ...
 * <li>Start your feathercoin client in test mode <code>feathercoin -testnet</code>. This will create a new sub-directory called testnet and should not interfere with normal wallets or operations.</li>
 * <li>(Optional) Choose a fresh address</li>
 * <li>(Optional) Visit the Testnet faucet (https://testnet.freefeathercoins.appspot.com/) to load your client with test coins</li>
 * <li>Run <code>PingService testnet</code></li>
 * <li>Wait for the block chain to download</li>
 * <li>Send some coins from your feathercoin client to the address provided in the PingService console</li>
 ...
 * .net/projects/feathercoin/files/Feathercoin/testnet-in-a-box/">testnet in a box</a> to do everything purely locally.</p>
 */
public class PingService {
    ...
    public PingService(String[] args) throws Exception {
        ...
        if (testNet) {
            peerGroup.addPeerDiscovery(new IrcDiscovery("#feathercoinTEST3"));
        } else {
        ...
        wallet.addEventListener(new AbstractWalletEventListener() {
            ...
            public void onCoinsReceived(Wallet w, Transaction tx, BigInteger prevBalance, BigInteger newBalance) {
                ...
                System.out.println("Received pending tx for " + Utils.feathercoinValueToFriendlyString(value) +
                        ": " + tx);
    ...
    private void bounceCoins(final Wallet wallet, Transaction tx) {
        // It's impossible to pick one specific identity that you receive coins from in Feathercoin as there
        ...
        try {
            ...
            System.out.println("Received " + Utils.feathercoinValueToFriendlyString(value) + " from " + from.toString());
