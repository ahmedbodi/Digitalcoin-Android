...
public class ToyWallet {
            ...
            switch (col) {
                ...
                case 2:
                    try {
                        ...
                        return Utils.feathercoinValueToFriendlyString(val);
    ...
    public ToyWallet(boolean testnet, boolean fullChain, String[] args) throws Exception {
        // Set up a Feathercoin connection + empty wallet. TODO: Simplify the setup for this use case.
        if (testnet) {
    ...
    private void setupWindow(JFrame window) {
        ...
        networkStats = new JLabel("Connecting to the Feathercoin network ...");
