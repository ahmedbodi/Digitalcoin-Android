...
import com.google.digitalcoin.discovery.IrcDiscovery;
...
/**
 * A command line tool for manipulating wallets and working with Digitalcoin.<p>
 */
public class WalletTool {
    ...
    public static class Condition {
        ...
        public boolean matchDigitalcoins(BigInteger comparison) {
            try {
    ...
    public static void main(String[] args) throws Exception {
        ...
        switch (netFlag.value(options)) {
            ...
            case TEST: 
                ...
                discovery = new IrcDiscovery("#digitalcoinTEST3");
                break;
            default:
                throw new RuntimeException("Unreachable.");
        }
    ...
    private static void send(List<String> outputs, BigInteger fee, String lockTimeStr, boolean allowUnconfirmed) {
        try {
            ...
            if (!wallet.completeTx(req)) {
                System.err.println("Insufficient funds: have " + Utils.digitalcoinValueToFriendlyString(wallet.getBalance()));
                return;
            }
            try {
                if (lockTimeStr != null) {
    ...
    private static void wait(WaitForEnum waitFor) throws BlockStoreException {
        ...
        switch (waitFor) {
            ...
            case BALANCE:
                ...
                if (condition.matchDigitalcoins(wallet.getBalance(Wallet.BalanceType.ESTIMATED))) {
                    latch.countDown();
                    break;
                }
                wallet.addEventListener(new AbstractWalletEventListener() {
                    ...
                    public synchronized void onChange() {
                        ...
                        if (condition.matchDigitalcoins(balance)) {
                            System.out.println(Utils.digitalcoinValueToFriendlyString(balance));
                            latch.countDown();
                        }
                    }
                });
    ...
    private static void deleteKey() {
        ...
        if (pubkey != null) {
            ...
            try {
                ...
                System.err.println(addr + " does not parse as a Digitalcoin address of the right network parameters.");
                return;
            }            
        }
        if (key == null) {
