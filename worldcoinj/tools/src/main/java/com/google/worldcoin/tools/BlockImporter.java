...
import com.google.digitalcoin.core.FullPrunedBlockChain;
...
import com.google.digitalcoin.store.H2FullPrunedBlockStore;
...
public class BlockImporter {
    public static void main(String[] args) throws Exception {
        ...
        if (System.getProperty("os.name").toLowerCase().indexOf("win") >= 0) {
            defaultDataDir = System.getenv("APPDATA") + "\\.digitalcoin/";
        } else {
            defaultDataDir = System.getProperty("user.home") + "/.digitalcoin/";
        }
